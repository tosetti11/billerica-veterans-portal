...
async function main() {
  ...
  if (formCount === 0) {
    await prisma.formTemplate.create({
      data: {
        name: "VA Disability Claim — Form 21-526EZ",
        slug: "va-disability-intake",
        description: "This fills the official VA Form 21-526EZ for disability compensation. All information you enter will be placed directly into the VA form.",
        serviceType: "va_disability",
        fields: JSON.stringify([
          { name: "fullName", label: "Full Legal Name (First Middle Last)", type: "text", required: true },
          { name: "ssn", label: "Social Security Number", type: "text", required: true, placeholder: "XXX-XX-XXXX" },
          { name: "dob", label: "Date of Birth", type: "date", required: true },
          { name: "address", label: "Current Mailing Address (Street, City, State ZIP)", type: "text", required: true },
          ...
          { name: "vaFileNumber", label: "VA File Number (if known)", type: "text", required: false },
          ...
          { name: "conditions", label: "Service-Connected Conditions (list each on a new line)", type: "textarea", required: true },
    ...
    await prisma.formTemplate.create({
      data: {
        name: "Property Tax Exemption — MA Form 96",
        slug: "property-tax-abatement",
        description: "This fills the official MA Form 96 for veterans property tax exemption under M.G.L. Chapter 59, Section 5.",
        serviceType: "property_tax_abatement",
        fields: JSON.stringify([
          { name: "fullName", label: "Full Legal Name", type: "text", required: true },
          { name: "address", label: "Property Address (Street, City, State ZIP)", type: "text", required: true },
          { name: "phone", label: "Phone Number", type: "text", required: true, placeholder: "(XXX) XXX-XXXX" },
          ...
          { name: "ownedOnJuly1", label: "Did you own the property on July 1?", type: "select", required: true, options: ["Yes", "No"] },
          { name: "assessedValue", label: "Assessed Valuation ($)", type: "number", required: true },
          ...
          { name: "vehicleInfo", label: "Vehicle Info (Year, Make, Model) if applicable", type: "text", required: false },
    ...
    await prisma.formTemplate.create({
      data: {
        name: "Chapter 115 Benefits — VS-1 Application",
        slug: "chapter-115-benefits",
        description: "This fills the official Massachusetts VS-1 form for Chapter 115 veterans benefits (financial assistance).",
        serviceType: "pension",
        fields: JSON.stringify([
          { name: "fullName", label: "Full Legal Name (First Middle Last)", type: "text", required: true },
          { name: "ssn", label: "Social Security Number", type: "text", required: true, placeholder: "XXX-XX-XXXX" },
          ...
          { name: "address", label: "Current Address (Street, Apt, City, State ZIP)", type: "text", required: true },
          { name: "phone", label: "Phone Number", type: "text", required: true, placeholder: "(XXX) XXX-XXXX" },
          { name: "spokenLanguage", label: "Primary Language Spoken", type: "text", required: false, placeholder: "English" },
          { name: "branch", label: "Branch of Service", type: "select", required: true, options: ["US Army", "US Navy", "US Air Force", "US Marine Corps", "US Coast Guard", "US Space Force"] },
          { name: "serviceStart", label: "Service Start Date", type: "date", required: true },
          { name: "serviceEnd", label: "Discharge / Separation Date", type: "date", required: true },
          ...
          { name: "maritalStatus", label: "Marital Status", type: "select", required: true, options: ["Single", "Married", "Divorced", "Widowed", "Separated"] },
          { name: "spouseName", label: "Spouse Full Name (if married)", type: "text", required: false },
          { name: "spouseDob", label: "Spouse Date of Birth", type: "date", required: false },
          { name: "spouseGender", label: "Spouse Gender", type: "select", required: false, options: ["Male", "Female"] },
          { name: "spouseSSN", label: "Spouse Social Security Number", type: "text", required: false },
          { name: "dependents", label: "Number of Dependents", type: "number", required: true },
          { name: "lastEmployer", label: "Last Employer", type: "text", required: false },
          { name: "employerCity", label: "Employer City/Town", type: "text", required: false },
          ...
          { name: "hasMedicalInsurance", label: "Do you have medical insurance?", type: "select", required: true, options: ["Yes", "No"] },
          { name: "insuranceCompany", label: "Insurance Company Name (if yes)", type: "text", required: false },
          { name: "needDescription", label: "Reason for Chapter 115 Application", type: "textarea", required: true },
          { name: "additionalInfo", label: "Additional Information", type: "textarea", required: false },
        ]),
        isActive: true,
      },
    ...
    await prisma.formTemplate.create({
      data: {
        name: "Burial Benefits — VA Form 21P-530EZ",
        slug: "burial-benefits",
        description: "This fills the official VA Form 21P-530EZ for burial benefits. Complete this form for a deceased veteran's burial allowance.",
        serviceType: "burial",
        fields: JSON.stringify([
          { name: "requestorName", label: "Your Name — Claimant (First Middle Last)", type: "text", required: true },
          { name: "claimantDob", label: "Your Date of Birth", type: "date", required: true },
          { name: "claimantAddress", label: "Your Mailing Address (Street, City, State ZIP)", type: "text", required: true },
          { name: "phone", label: "Your Phone Number", type: "text", required: true, placeholder: "(XXX) XXX-XXXX" },
          { name: "email", label: "Your Email Address", type: "text", required: false },
          ...
          { name: "veteranName", label: "Veteran's Full Legal Name (First Middle Last)", type: "text", required: true },
          { name: "veteranSSN", label: "Veteran's Social Security Number", type: "text", required: true, placeholder: "XXX-XX-XXXX" },
          { name: "vaClaimNumber", label: "VA File Number (if known)", type: "text", required: false },
          ...
          { name: "placeOfDeath", label: "Place of Death (City, State)", type: "text", required: true },
          { name: "burialDate", label: "Date of Burial", type: "date", required: true },
          { name: "burialLocation", label: "Burial Location / Cemetery Name", type: "text", required: true },
          ...
          { name: "serviceStart", label: "Date Entered Active Service", type: "date", required: true },
          { name: "serviceEnd", label: "Date Separated from Service", type: "date", required: true },
          { name: "serviceNumber", label: "Service Number (if different from SSN)", type: "text", required: false },
          { name: "placeOfEntry", label: "Place of Entry into Service", type: "text", required: false },
          { name: "placeSeparated", label: "Place of Separation from Service", type: "text", required: false },
